...
export default function Register() {
    ...
    const onFormSubmit = () => {
        ...
        formData.append('firstName', formRef.current);
    ...
    return (
        <div className="main-container">
            <div>
                <form className="register-form-container" encType="multipart/form-data" action="/saveUser" method="POST" id="uploadForm" ref={formRef}>
                    ...
                    <br></br>
                    <label>Image: </label>
                    <input ref={fileInputRef} type="file" name="imageFileName" id="imageFileName" accept=".jpg" onChange={onFormSubmit}></input>
                    <br></br>
