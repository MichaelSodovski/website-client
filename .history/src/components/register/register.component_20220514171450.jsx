...
export default function Register() {
    ...
    return (
        <div className="main-container">
            <div>
                <form encType="multipart/form-data" className="register-form-container" action="/saveUser" method="POST">
                    ...
                    <br></br>
                    <label>Image: </label>
                    <input ref={fileInputRef} type="file" name="imageFileName" id="imageFileName" accept=".dwg,.zip" onChange={onFileChange}></input>
                    <br></br>
